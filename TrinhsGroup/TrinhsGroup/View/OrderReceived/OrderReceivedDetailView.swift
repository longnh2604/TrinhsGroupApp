        ...
        VStack(alignment: .leading, spacing: 8) {
            HStack {
                ...
                VStack(alignment: .leading, spacing: 4) {
                    ...
                    Text(getPriceAndCurrencySymbol(price: mainViewModel.receivedOrder.total, currency: mainViewModel.appSetting!.currency_symbol.decodingHTMLEntities(), currencyPosition: mainViewModel.appSetting!.currency_position))
                        .font(.custom(Constants.AppFont.semiBoldFont, size: 14))
