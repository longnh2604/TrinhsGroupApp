...
enum L10n {
    ...
    enum Profile {
        ...
        static let dangerZone = "profile.dangerZone"
        static let deleteAccount = "profile.deleteAccount"
        static let deleteAccountSubtitle = "profile.deleteAccountSubtitle"
        static let deleteAccountConfirmTitle = "profile.deleteAccountConfirmTitle"
        static let deleteAccountConfirmMessage = "profile.deleteAccountConfirmMessage"
        static let deleteAccountErrorMessage = "profile.deleteAccountErrorMessage"
        static let deleteAccountButton = "profile.deleteAccountButton"
        ...
        static let paymentSummary = "profile.paymentSummary"
        static let pickupDetails = "profile.pickupDetails"
